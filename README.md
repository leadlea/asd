...
| **docx レビューコメント対応** | ⏳ レビュー確認中 | コメント #1561（表6と散布図の数値整合）について[検証完了・案A推奨](docs/homework/soda_comment_1561_analysis.md)。他コメントは週末レビュー後に一括対応予定 |
...
| [レビューコメント #1561 検証メモ](docs/homework/soda_comment_1561_analysis.md) | 表6と予測値vs観測値散布図の数値整合性の検証・修正方針 |
| [作業報告（docx v1対応）](docs/worklog_2026-04-02_soda_feedback_v1.md) | 4本柱＋細かいコメント対応の全記録 |
...
| `verify_predicted_vs_three_stage.py` | 🆕 表6（3段階Ridge Stage3）と予測値vs観測値散布図の r 整合性検証（レビューコメント #1561 対応） |
