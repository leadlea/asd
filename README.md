...
| **宗田さんレビュー v2 対応** | ⏳ 山下先生ジャッジ待ち | docx校閲コメント52件抽出・整理済み。#1561（数値ずれ疑義）は[検証完了・案A推奨](docs/homework/soda_comment_1561_analysis.md) |
...
| [宗田さんコメント #1561 検証メモ](docs/homework/soda_comment_1561_analysis.md) | 表6と予測値vs観測値散布図の数値ずれ検証・修正方針 |
...
| `verify_predicted_vs_three_stage.py` | 🆕 表6（3段階Ridge Stage3）と予測値vs観測値散布図の r 整合性検証（宗田さんコメント #1561 対応） |
