...
| **編集プラットフォーム** | 🔄 再相談中 | 宗田さんがLaTeXコードをWord/Google Docで共同編集する案を提示（コメント＋修正履歴を残すため）。現状はgitベース継続、原本 `paper1_ja_st.tex` 不変・修正は `paper1_ja_st_rev_20260706.tex`。3者で方針確定予定 |
...
> **提出前チェック**: 山下先生提出前に、ドライバが5個に変わった§3.4.4〜考察の流れを福原が通読で最終確認する（実施予定）。
