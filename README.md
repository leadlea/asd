...
| **編集プラットフォーム** | ✅ 確定 | Overleaf移行は取りやめ。gitベースで継続（原本 `paper1_ja_st.tex` を不変保持、修正は `paper1_ja_st_rev_20260705.tex`）。宗田さんとはdiffでやり取り |
...
| [論文ドラフト（修正版）](paper1_ja_st_rev_20260705.tex) | 🆕 上記への福原の修正を集約した現行作業版（43ページ）。`diff paper1_ja_st.tex paper1_ja_st_rev_20260705.tex` で差分確認 |
...
├── paper1_ja_st_rev_20260705.tex  # 修正版（現行作業版・43ページ）
