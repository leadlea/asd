...
- **重要な点として、本研究の主たる貢献は特徴量の提案そのものにあり**、Big5性格特性との関連分析は、提案指標の構成概念妥当性（construct validity）を検証するための手段として位置づけられる。
...
本節では、提案特徴量と外部の心理学的構成概念（Big5性格特性）との関連を報告する。**本分析は特徴量の構成概念妥当性（construct validity）の検証であり、性格推定モデルの構築を目的としない。**
