...
## 5. Big Five 性格特性（Personality Traits）

| 日本語 | English | 略号 | 備考 |
|:--|:--|:--:|:--|
| Big Five 性格特性 | Big Five personality traits | — | "Big5" は略記で可（散文では Big Five） |
...
| アンサンブルBig5 | ensemble Big Five | — | 4 LLM 教師の item-level 平均 |
| アンサンブル | ensemble | — | |
